...
function initEvent() {
	...
	$('#mrpGatheringSearchButton').on("click", function() { 
		...
		$.ajax({ 
			type : 'GET',
			url : '${pageContext.request.contextPath}/production/mrp/mrpgathering/list' ,
			data : {
...
<body>
	...
	<fieldset style="display: inline;">
	    <legend>소요량취합 검색</legend>
    		<label for="radio-1"style="color: white;" >발주/작업지시 기한</label>
    		<input type="radio" name="searchDateCondition" value="claimDate" id="radio-1" checked>
    		<label for="radio-2" style="color: white;">발주/작업지시 완료 기한</label>
