...
<article class="contract">
    <div class="contract__Title">
        <h5 style="color: black;">📋 수주 등록</h5>
        <div style="color: black">
            <label for="searchByDateRadio" style="color: black;" >일자 검색</label>
...
<script>
  ...
  $("#listModal").on('hide.bs.modal', function () {
    ...
    console.log("contractRowNode???"+contractRowNode);
  ...
  function setDataOnCustomerName() {
    ...
    if(to==undefined){
      ...
      console.log("to.detailCode???"+to.detailCode);
      ...
      xhr.onreadystatechange = () => {
        if (xhr.readyState == 4 && xhr.status == 200) {
          ...
          //Swal.fire("data",,"success")
           console.log("txt.gridRowJson??"+txt.gridRowJson);
           let conDNStr="";
          const conDetailList = Object.values(txt.gridRowJson);//어레이라이크를 배열형태로 바꿔줌
            console.log("conDetailList??"+conDetailList);
