...
<head>
  ...
  <head>
    ...
    <script>
      ...
      function Map()
      {
        var Y_point = 35.0691457;        // Y 좌표
        var X_point = 128.1110659;        // X 좌표
        var zoomLevel = 18;                // 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
        var markerTitle = "송보파인빌아파트";        // 현재 위치 마커에 마우스를 오버을때 나타나는 정보
        var markerMaxWidth = 300;                // 마커를 클릭했을때 나타나는 말풍선의 최대 크기
        var contentString    = '<div>' +      // 말풍선 내용
                '<h2>오시는 길</h2>'+
                '<p>주소 : 경상남도 사천시 정동면 여옥길 520-1 송보파인빌</p>' +
      ...
      function showTermsListGrid(findTermsBean)
      {
        ...
        const columnDef =
                [
                  ...
                  { headerName : "채용양식", field : "pdf_file" }
                ];
        console.log(findTermsBean[0]);
...
<section id="tabs" style="width:100%;height:1100px;" class="wow fadeInDown">
  <div class="container">
    <div id = "dv_body">
      <h6 class="section-title h3" style="text-align=left;">오시는 길</h6>
      ...
      <%--
      <h6 class="section-title h3" style="text-align=left;">기초 조건 양식</h6>
      <hr style="background-color:white; height: 1px;">
      ...
      <input type = "button" value="전송" id = "condition_form" class="btn btn-light" />
      <input type = "reset" value="취소" id="resetvalue" class="btn btn-light" />
      <br/>
      <br/>
      <h6 class="section-title h3" style="text-align=left;">년도별 인적 사항 조건</h6>
      <hr style="background-color:white; height: 1px;">
      <div >
