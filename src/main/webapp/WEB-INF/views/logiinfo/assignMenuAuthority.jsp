...
<body>
<h4 style="color: black;">🚫메뉴권한설정</h4>
<h6 style="color: black;">등록할 메뉴를 <span style='color:red'>모두</span> 선택하세요</h6>
<table>
<tr>
<td> 
<article class="AuthorityGroupGrid">
    <h5 style="color: black;">🐱권한그룹</h5>
    <div align="center">
