...
public class BomController {
	...
	public ModelMap searchBomDeploy(@RequestParam("deployCondition")String deployCondition,@RequestParam("itemCode")String itemCode,@RequestParam("itemClassificationCondition")String itemClassificationCondition) {
