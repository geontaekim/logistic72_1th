...
public class OrderController {
	...
	public ModelMap checkOrderInfo(@RequestParam("orderNoList")String orderNoListStr) {
		...
		System.out.print(orderNoListStr);
		map = new ModelMap();
		try {
	...
	public ModelMap openOrderDialog(@RequestParam("mrpNoListStr")String mrpNoListStr) {
	...
	public ModelMap order(@RequestParam("mrpGatheringNoListStr")String mrpGatheringNoListStr) {
